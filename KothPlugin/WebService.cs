...
namespace KothPlugin
{
    internal static class WebService
    {
        ...
        private const int Port = 8888; //TODO config //Done

        private const string Host = "localhost"; //TODO config //Done

        private const bool ApiEnabled = true; //TODO config //Done

        private const bool WebPageEnabled = true; //TODO config //Done 
